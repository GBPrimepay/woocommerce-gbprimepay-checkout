...
if(isset($JSON_GET["page"]) && !empty($JSON_GET["page"])){
  ...
  $res .=  '<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">' .
          ...
          '<meta http-equiv="Content-Security-Policy" content="form-action checkout.beprovider.net api.gbprimepay.com checkout.gbprimepay.com api.globalprimepay.com checkout.globalprimepay.com" />' .
