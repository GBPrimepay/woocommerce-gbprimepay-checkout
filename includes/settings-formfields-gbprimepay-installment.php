...
return apply_filters('as_gbprimepay_installment_settings',
    array(
        ...
        'thanachart_installment_term' => array(
          'title' => __( 'THANACHART', 'gbprimepay-payment-gateways-installment' ),
          'type' => 'text',
          'description' => __( 'Thanachart Bank Public Company Limited. <br>Installment Terms. default: <b>3, 4, 6, 10</b>', 'gbprimepay-payment-gateways-installment' ),
          'default' => '3, 4, 6, 10'
        ),
