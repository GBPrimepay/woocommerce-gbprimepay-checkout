    ...
    class AS_Gbprimepay
    {
        ...
        protected function __construct()
        {
            ...
            add_filter( 'template_include', array($this, 'gbprimepay_qrwechat_page_template'));
						...
						// linepay
            add_action( 'wp_ajax_check_linepay_order_status', array( $this, 'my_check_linepay_order_status' ) );
            add_action( 'wp_ajax_nopriv_check_linepay_order_status', array( $this, 'my_check_linepay_order_status' ) );
            add_action( 'init', array( $this, 'create_gbprimepay_linepay_post_type' ) );
            add_action( 'init', array( $this, 'create_gbprimepay_linepay_payment_page' ) );
            add_filter( 'template_include', array($this, 'gbprimepay_linepay_page_template'));
						

						// truewallet
            add_action( 'wp_ajax_check_truewallet_order_status', array( $this, 'my_check_truewallet_order_status' ) );
            add_action( 'wp_ajax_nopriv_check_truewallet_order_status', array( $this, 'my_check_truewallet_order_status' ) );
            add_action( 'init', array( $this, 'create_gbprimepay_truewallet_post_type' ) );
            add_action( 'init', array( $this, 'create_gbprimepay_truewallet_payment_page' ) );
            add_filter( 'template_include', array($this, 'gbprimepay_truewallet_page_template'));
						

						// mbanking
            add_action( 'wp_ajax_check_mbanking_order_status', array( $this, 'my_check_mbanking_order_status' ) );
            add_action( 'wp_ajax_nopriv_check_mbanking_order_status', array( $this, 'my_check_mbanking_order_status' ) );
            add_action( 'init', array( $this, 'create_gbprimepay_mbanking_post_type' ) );
            add_action( 'init', array( $this, 'create_gbprimepay_mbanking_payment_page' ) );
            add_filter( 'template_include', array($this, 'gbprimepay_mbanking_page_template'));
